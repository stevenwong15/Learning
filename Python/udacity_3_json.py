...
def parse(start_symbol, text, grammar):
    ...
    # go through each element in the list, that is in the tuple
...
# Q: how to define a grammar that does */ before +-? 
# In: Exp => Term [+-] Exp | Term
# Exp is recursive, [+-] is regular expression, Term is base case
# 
